    ...
    var table = $("#dataTable");
    var url = "/crud_inventory/kategori/list_all_data";
    ...
    if(table.length > 0) {
        $(table).dataTable({
            ...
            "sAjaxSource": url,
            "aoColumns": [
                {"sTitle": "ID", "mData": "kategori_produk_id"},
                {"sTitle": "Kategori Produk", "mData": "kategori_name"},
                {
...
var askToDelete = function(aid = null) {
    ...
    var url = "/crud_inventory/kategori/delete";
